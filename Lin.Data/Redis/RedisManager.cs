...
namespace Lin.Data.Redis
{
    class RedisManager
    {
        ...
        /// redis配置文件信息
        /// </summary>
        private static string RedisPath = GlobaSettings.GlobaSettings.RedisConnectionString;
        ...
        private static PooledRedisClientManager CreateManager(string[] readWriteHosts, string[] readOnlyHosts)
        {
            ...
            {
                MaxWritePoolSize = GlobaSettings.GlobaSettings.RedisMaxWritePool, // “写”链接池链接数 
                MaxReadPoolSize = GlobaSettings.GlobaSettings.RedisMaxReadPool, // “读”链接池链接数 
                AutoStart = true,
            });
        }
